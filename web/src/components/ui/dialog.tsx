      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            // `end-4` is a Tailwind v4 logical property: it resolves
            // to `right` in LTR and `left` in RTL, so the close
            // button stays at the trailing-top corner of the dialog
            // regardless of the page direction. Adding an English
            // locale later requires zero changes here.
