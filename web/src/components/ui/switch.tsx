...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      data-slot="switch"
      data-size={size}
      // Force LTR so the thumb's translate animation stays consistent
      // regardless of the ancestor direction. Inside an RTL tree the
      // unchecked thumb would otherwise stick to the wrong side and look
      // broken when the track grows around it.
      dir="ltr"
      className={cn(
